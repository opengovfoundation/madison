...
<div class="nav nav-main navbar-collapse collapse">
	<ul class="nav navbar-nav navbar-right">
		<li class="link-government"><a href="http://www.gob.mx/presidencia">{{ trans('messages.government') }}</a></li>
		<li class="link-services"><a href="http://www.gob.mx/tramites">{{ trans('messages.services') }}</a></li>
    <li class="dropdown">
