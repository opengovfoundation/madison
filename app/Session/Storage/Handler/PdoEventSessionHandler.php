 ...
 */
class PdoEventSessionHandler implements \SessionHandlerInterface
{
    /**
    ...
    {
        Event::fire('session.open', array($this, $savePath, $sessionName));
        return true;
    }
    ...
    {
        Event::fire('session.close', array($this));
        return true;
    }
    ...
    {
        Event::fire('session.destroy', array($this, $sessionId));
        ...
        Event::fire('session.destroy.after', array($this, $sessionId));
    ...
    {
        Event::fire('session.gc', array($this));
        ...
        Event::fire('session.gc.after', array($this));
    ...
    {
        Event::fire('session.read', array($this, $sessionId));
    ...
    public function write($sessionId, $data)
    {
        ...
        try {
            ...
            Event::fire('session.write.after', array($this, $sessionId, $data));
        } catch (\PDOException $e) {
